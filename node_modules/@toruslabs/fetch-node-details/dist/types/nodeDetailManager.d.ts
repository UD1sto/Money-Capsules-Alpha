...
import { ETHEREUM_NETWORK_TYPE, INodeDetails, INodePub, NodeDetailManagerParams } from "./interfaces";
declare class NodeDetailManager {
    _currentEpoch: string;
    _torusNodeEndpoints: string[];
    _torusNodePub: INodePub[];
    _torusIndexes: number[];
    _network: ETHEREUM_NETWORK_TYPE | string;
    ...
    getNodeDetails({ skip, verifier, verifierId }: {
        skip?: boolean;
        verifier: string;
        verifierId: string;
