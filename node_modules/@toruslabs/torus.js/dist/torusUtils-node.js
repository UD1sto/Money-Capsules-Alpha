...
function httpHelpers_esm_setEmbedHost(embedHost_) {
...
function httpHelpers_esm_setAPIKey(apiKey_) {
  apiKey = apiKey_;
}
...
var loglevel_log = external_loglevel_default().getLogger("torus.js");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            _context2.next = 12;
            return post(endpoints[nodeNum], utils_objectSpread(utils_objectSpread({}, data), signedData), {
              headers: {
                "Content-Type": "application/json; charset=utf-8"
              }
            });
...
var Torus = /*#__PURE__*/function () {
  ...
  createClass_default()(Torus, [{
    ...
    value: function setAPIKey(apiKey) {
      httpHelpers_esm_setAPIKey(apiKey);
    }
  }, {
    key: "setEmbedHost",
    value: function setEmbedHost(embedHost) {
      httpHelpers_esm_setEmbedHost(embedHost);
    }
  }, {
