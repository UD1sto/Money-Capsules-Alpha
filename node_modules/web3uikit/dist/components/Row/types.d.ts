declare type alignStyles = 'start' | 'end' | 'center' | 'stretch' | 'baseline';
declare type justifyStyles = 'flex-start' | 'flex-end' | 'center' | 'space-between' | 'space-around' | 'space-evenly';
