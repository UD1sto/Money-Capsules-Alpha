...
contract Swap {
    ...
    function requestSwap(address userCapsule, address swapWithUser, address swapCapsule) external {
        require(
            swapWithUser != address(0) || swapCapsule != address(0) || userCapsule != address(0),
