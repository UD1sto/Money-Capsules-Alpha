...
contract MixedCapsule is OwnableUpgradeable{
    ...
    function transferAny(address erc20Adress, address payable recipient,uint256 amount) public onlyOwner {
        require(erc20Adress != Tokens.mockToken1 && erc20Adress != Tokens.mockToken2 &&
        erc20Adress != Tokens.mockToken3 && erc20Adress != Tokens.mockToken4 && erc20Adress != Tokens.mockToken5 &&
        erc20Adress != Tokens.mockToken6, "Illigal Token Transfer");
    ...
    function transferTokenS1(address erc20Adress, address payable recipient,uint256 amount) public {
        require(amount != 0);
    ...
    function transferTokenS2(address erc20Adress, address payable recipient,uint256 amount) public {
        require(amount != 0);
    ...
    function transferTokenS3(address erc20Adress, address payable recipient,uint256 amount) public  {
        require(amount != 0);
       ...
       function withdraw721(address nft721, address to, uint id) public onlyOwner {
        IERC721(nft721).transferFrom(address(this), to, id);
    }

    function withdraw1155(address nft1155, address to, uint id, uint amount, bytes calldata data) public onlyOwner{
        IERC1155(nft1155).safeTransferFrom(address(this), to, id, amount, data);
    }

    function batchWithdraw(address nft1155, address to, uint256[] calldata ids, uint256[] calldata amounts, bytes calldata data)
    public onlyOwner {
